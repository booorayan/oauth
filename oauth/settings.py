...
OIDC_RP_CLIENT_ID = env('CLIENT_ID')
OIDC_RP_CLIENT_SECRET = env('CLIENT_SECRET')

OIDC_OP_AUTHORIZATION_ENDPOINT = env('AUTHORIZATION_ENDPOINT')
OIDC_OP_TOKEN_ENDPOINT = env('TOKEN_ENDPOINT')
OIDC_OP_USER_ENDPOINT = env('USER_ENDPOINT')
